...
| --- | --- | --- | --- |
| max-age | int64 | No | The maximum age, in seconds, for cached items to persist. Default is (7) days. |
| max-size | int64 | No | The maximum size, in bytes, for the total number of cached items. Default is 10GB. |
